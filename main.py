class Ui_MainWindow(object):
    ...
    def trainingFunction(self):
        ...
        training_set = train_datagen.flow_from_directory(
            'D:/MasterClass/Artificial_Intelligence/Day15/Gujarathi_character_recognition_CNN/Dataset/train',
            target_size=(128, 128),
            batch_size=8,
        ...
        test_set = test_datagen.flow_from_directory(
            'D:/MasterClass/Artificial_Intelligence/Day15/Gujarathi_character_recognition_CNN/Dataset/val',
            target_size=(128, 128),
            batch_size=8,
            class_mode='categorical')
